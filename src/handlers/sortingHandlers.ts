...
const handleBubbleSort = (array: number[], setArray: React.Dispatch<React.SetStateAction<number[]>>, setIsSorting: React.Dispatch<React.SetStateAction<boolean>>, setNumberOfSteps: React.Dispatch<React.SetStateAction<number>>, setAlgorithm: React.Dispatch<React.SetStateAction<string>>, timeoutRefs: React.MutableRefObject<NodeJS.Timeout[]>, SPEED : number) => {
...
const handleMergeSort = (array: number[], setArray: React.Dispatch<React.SetStateAction<number[]>>, setIsSorting: React.Dispatch<React.SetStateAction<boolean>>, setNumberOfSteps: React.Dispatch<React.SetStateAction<number>>, setAlgorithm: React.Dispatch<React.SetStateAction<string>>, timeoutRefs: React.MutableRefObject<NodeJS.Timeout[]>, SPEED : number) => {
...
const handleQuickSort = (array: number[], setArray: React.Dispatch<React.SetStateAction<number[]>>, setIsSorting: React.Dispatch<React.SetStateAction<boolean>>, setNumberOfSteps: React.Dispatch<React.SetStateAction<number>>, setAlgorithm: React.Dispatch<React.SetStateAction<string>>, timeoutRefs: React.MutableRefObject<NodeJS.Timeout[]>, SPEED : number) => {
